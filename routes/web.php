...
Route::get('/{post}',                        [PostsController::class, 'show']);          #Can be accessed by public
Route::get('/admin/{post}/edit',             [PostsController::class, 'edit']);
...
Route::get('/category/{category}',           [CategoriesController::class, 'show']);     #Can be accessed by public
Route::get('/admin/category/{category}',     [CategoriesController::class, 'edit']);
